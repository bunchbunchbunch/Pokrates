 ...
 * Time: 9:49 AM
 */
public class EquivalenceHandEvaluator implements HandEvaluator {

    private static EquivalenceHandEvaluator instance;
    public Map<Integer, Integer> flushHands;
    public Map<Integer, Integer> nonFlushHands;
    public Map<Integer, String> handNames;

    protected EquivalenceHandEvaluator() {
    ...
    public static EquivalenceHandEvaluator getInstance() {
        if(instance == null)
            instance = new EquivalenceHandEvaluator();
        return instance;
    }
